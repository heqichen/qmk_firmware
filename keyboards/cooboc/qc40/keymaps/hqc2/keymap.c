...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_1] = LAYOUT_QC40_V2(
        KC_TRNS, KC_TRNS, KC_WH_U, KC_MS_U, KC_WH_D, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_END, KC_PGUP, KC_PGDN, KC_MINS, KC_EQL,
        KC_TRNS, KC_CAPS, KC_MS_L, KC_MS_D, KC_MS_R, KC_WBAK, KC_WFWD, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_TRNS, KC_BSLS, KC_TRNS,
